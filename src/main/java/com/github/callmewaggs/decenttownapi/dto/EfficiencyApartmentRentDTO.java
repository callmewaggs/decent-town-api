...
public class EfficiencyApartmentRentDTO {
  ...
  public static EfficiencyApartmentRentDTO parseEfficiencyApartmentRentResponseDTO(URL url)
      throws IOException {
    return objectMapper.readValue(url, EfficiencyApartmentRentDTO.class);
  }
  ...
  static class Item {
    ...
    @JacksonXmlProperty(localName = "보증금")
    public String deposit;

    @JacksonXmlProperty(localName = "월세")
